...
set name Conv2D_HW_mul_62s_62s_62_5_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 4 ALLOW_PRAGMA 1
}


set name Conv2D_HW_mul_32ns_32ns_62_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name Conv2D_HW_mul_62s_32ns_62_5_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 4 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    id 13 \
    name inputHeight_cast9 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_inputHeight_cast9 \
    op interface \
    ports { inputHeight_cast9 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_convWidth_cast \
    op interface \
    ports { convWidth_cast { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln15_1 \
    op interface \
    ports { mul_ln15_1 { I 96 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln1027_1 \
    op interface \
    ports { mul_ln1027_1 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 21 \
    name tmp3_cast_mid144 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_tmp3_cast_mid144 \
    op interface \
    ports { tmp3_cast_mid144 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 24 \
    name inputWidth_cast10 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_inputWidth_cast10 \
    op interface \
    ports { inputWidth_cast10 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_x_V_cast13 \
    op interface \
    ports { x_V_cast13 { I 32 vector } } \
} "
}
