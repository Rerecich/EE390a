...
localparam
    ...
    ADDR_NUMFILTERS_CTRL    = 7'h40,
    ADDR_INPUTWIDTH_DATA_0  = 7'h44,
    ADDR_INPUTWIDTH_CTRL    = 7'h48,
    ADDR_INPUTHEIGHT_DATA_0 = 7'h4c,
    ADDR_INPUTHEIGHT_CTRL   = 7'h50,
    ADDR_CONVWIDTH_DATA_0   = 7'h54,
    ADDR_CONVWIDTH_CTRL     = 7'h58,
    ADDR_CONVHEIGHT_DATA_0  = 7'h5c,
    ADDR_CONVHEIGHT_CTRL    = 7'h60,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
