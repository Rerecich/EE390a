...
architecture behave of Conv2D_HW_control_s_axi is
    ...
    constant ADDR_NUMFILTERS_CTRL    : INTEGER := 16#40#;
    constant ADDR_INPUTWIDTH_DATA_0  : INTEGER := 16#44#;
    constant ADDR_INPUTWIDTH_CTRL    : INTEGER := 16#48#;
    constant ADDR_INPUTHEIGHT_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_INPUTHEIGHT_CTRL   : INTEGER := 16#50#;
    constant ADDR_CONVWIDTH_DATA_0   : INTEGER := 16#54#;
    constant ADDR_CONVWIDTH_CTRL     : INTEGER := 16#58#;
    constant ADDR_CONVHEIGHT_DATA_0  : INTEGER := 16#5c#;
    constant ADDR_CONVHEIGHT_CTRL    : INTEGER := 16#60#;
