...
-- 0x5c : reserved
-- 0x60 : Data signal of convWidth
--        bit 31~0 - convWidth[31:0] (Read/Write)
-- 0x64 : reserved
-- 0x68 : Data signal of convHeight
...
architecture behave of Conv2D_HW_control_s_axi is
    ...
    constant ADDR_BIASES_DATA_0      : INTEGER := 16#34#;
    constant ADDR_BIASES_DATA_1      : INTEGER := 16#38#;
    constant ADDR_BIASES_CTRL        : INTEGER := 16#3c#;
    constant ADDR_NUMCHANNELS_DATA_0 : INTEGER := 16#40#;
    constant ADDR_NUMCHANNELS_CTRL   : INTEGER := 16#44#;
    constant ADDR_NUMFILTERS_DATA_0  : INTEGER := 16#48#;
    constant ADDR_NUMFILTERS_CTRL    : INTEGER := 16#4c#;
    constant ADDR_INPUTWIDTH_DATA_0  : INTEGER := 16#50#;
    constant ADDR_INPUTWIDTH_CTRL    : INTEGER := 16#54#;
    constant ADDR_INPUTHEIGHT_DATA_0 : INTEGER := 16#58#;
    constant ADDR_INPUTHEIGHT_CTRL   : INTEGER := 16#5c#;
    constant ADDR_CONVWIDTH_DATA_0   : INTEGER := 16#60#;
    constant ADDR_CONVWIDTH_CTRL     : INTEGER := 16#64#;
    constant ADDR_CONVHEIGHT_DATA_0  : INTEGER := 16#68#;
    constant ADDR_CONVHEIGHT_CTRL    : INTEGER := 16#6c#;
    constant ADDR_APPLY_RELU_DATA_0  : INTEGER := 16#70#;
    constant ADDR_APPLY_RELU_CTRL    : INTEGER := 16#74#;
...
-- ----------------------- Register logic ----------------
    ...
    apply_relu           <= STD_LOGIC_VECTOR(int_apply_relu);
