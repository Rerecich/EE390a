...
#define AUTOTB_TVIN_biases "../tv/cdatafile/c.Conv2D_HW.autotvin_biases.dat"
#define AUTOTB_TVOUT_biases "../tv/cdatafile/c.Conv2D_HW.autotvout_biases.dat"
...
#define AUTOTB_TVIN_apply_relu "../tv/cdatafile/c.Conv2D_HW.autotvin_apply_relu.dat"
#define AUTOTB_TVOUT_apply_relu "../tv/cdatafile/c.Conv2D_HW.autotvout_apply_relu.dat"
...
void apatb_Conv2D_HW_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r, void* __xlx_apatb_param_coeffs, void* __xlx_apatb_param_biases, hls::sim::Byte<4> __xlx_apatb_param_numChannels, hls::sim::Byte<4> __xlx_apatb_param_numFilters, hls::sim::Byte<4> __xlx_apatb_param_inputWidth, hls::sim::Byte<4> __xlx_apatb_param_inputHeight, hls::sim::Byte<4> __xlx_apatb_param_convWidth, hls::sim::Byte<4> __xlx_apatb_param_convHeight, hls::sim::Byte<4> __xlx_apatb_param_apply_relu)
{
  ...
  port3.param = &__xlx_offset_byte_param_biases;
  ...
  __xlx_offset_byte_param_output_r = 20000*4;
  __xlx_offset_byte_param_coeffs = 40000*4;
  __xlx_offset_byte_param_biases = 60000*4;
  port11.param = { __xlx_apatb_param_input_r, __xlx_apatb_param_output_r, __xlx_apatb_param_coeffs, __xlx_apatb_param_biases };
  port11.depth = { 20000, 20000, 20000, 20000 };
  port11.offset = { 0, 20000, 40000, 60000 };
  port11.hasWrite = { true, true, true, true };
  ...
  try {
    ...
    Conv2D_HW_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r, __xlx_apatb_param_coeffs, __xlx_apatb_param_biases, __xlx_apatb_param_numChannels, __xlx_apatb_param_numFilters, __xlx_apatb_param_inputWidth, __xlx_apatb_param_inputHeight, __xlx_apatb_param_convWidth, __xlx_apatb_param_convHeight, __xlx_apatb_param_apply_relu);
