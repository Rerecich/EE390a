...
__xlx_input_r_output_r_coeffs_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 20000;
...
__xlx_input_r_output_r_coeffs_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 20000;
  int __xlx_offset_param_output_r = 20000;
  int __xlx_offset_byte_param_output_r = 20000*4;
for (size_t i = 0; i < 20000; ++i){
__xlx_input_r_output_r_coeffs_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_coeffs)[i]);
}
  int __xlx_size_param_coeffs = 20000;
  int __xlx_offset_param_coeffs = 40000;
  int __xlx_offset_byte_param_coeffs = 40000*4;
for (size_t i = 0; i < 20000; ++i){
__xlx_input_r_output_r_coeffs_biases__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_biases)[i]);
}
  int __xlx_size_param_biases = 20000;
  int __xlx_offset_param_biases = 60000;
  int __xlx_offset_byte_param_biases = 60000*4;
  // DUT call
