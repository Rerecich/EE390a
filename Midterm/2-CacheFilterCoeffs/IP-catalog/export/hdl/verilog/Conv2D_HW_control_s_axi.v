...
localparam
    ...
    ADDR_BIASES_DATA_0      = 7'h34,
    ADDR_BIASES_DATA_1      = 7'h38,
    ADDR_BIASES_CTRL        = 7'h3c,
    ADDR_NUMCHANNELS_DATA_0 = 7'h40,
    ADDR_NUMCHANNELS_CTRL   = 7'h44,
    ADDR_NUMFILTERS_DATA_0  = 7'h48,
    ADDR_NUMFILTERS_CTRL    = 7'h4c,
    ADDR_INPUTWIDTH_DATA_0  = 7'h50,
    ADDR_INPUTWIDTH_CTRL    = 7'h54,
    ADDR_INPUTHEIGHT_DATA_0 = 7'h58,
    ADDR_INPUTHEIGHT_CTRL   = 7'h5c,
    ADDR_CONVWIDTH_DATA_0   = 7'h60,
    ADDR_CONVWIDTH_CTRL     = 7'h64,
    ADDR_CONVHEIGHT_DATA_0  = 7'h68,
    ADDR_CONVHEIGHT_CTRL    = 7'h6c,
    ADDR_APPLY_RELU_DATA_0  = 7'h70,
    ADDR_APPLY_RELU_CTRL    = 7'h74,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
...
assign apply_relu        = int_apply_relu;
// int_interrupt
always @(posedge ACLK) begin
    if (ARESET)
        int_interrupt <= 1'b0;
