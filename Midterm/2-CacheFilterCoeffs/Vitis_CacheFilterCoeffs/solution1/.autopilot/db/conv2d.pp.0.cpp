...
{
#line 16 "/home/rerecich/EE-390a/CNN/Midterm/Midterm/2-CacheFilterCoeffs/Vitis_CacheFilterCoeffs/solution1/csynth.tcl"
...
#pragma HLS ARRAY_PARTITION variable=coeff_cache complete dim=1
 ...
 LOOP_loadCoeffs:
  for (ap_uint<32> iChannel = 0; iChannel < numChannels; ++iChannel) {
      VITIS_LOOP_45_2: for (ap_uint<32> cy = 0; cy < convHeight; ++cy) {
         VITIS_LOOP_46_3: for (ap_uint<32> cx = 0; cx < convWidth; ++cx) {
  ...
  LOOP_Conv:
     for (ap_uint<32> y = 0; y < (inputHeight-2); ++y) {
       ...
       VITIS_LOOP_60_4: for (ap_uint<32> x = 0; x < (inputWidth-2); ++ x) {
         TFXP acc = 0;

         VITIS_LOOP_63_5: for (ap_uint<32> iChannel = 0; iChannel < numChannels; ++ iChannel) {

           VITIS_LOOP_65_6: for (ap_uint<32> cy = 0; cy < convHeight; ++ cy) {

             VITIS_LOOP_67_7: for (ap_uint<32> cx = 0; cx < convWidth; ++cx) {
