...
void XConv2d_hw_Set_input_r(XConv2d_hw *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_INPUT_R_DATA, (u32)(Data));
    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_INPUT_R_DATA + 4, (u32)(Data >> 32));
}

u64 XConv2d_hw_Get_input_r(XConv2d_hw *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XConv2d_hw_ReadReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_INPUT_R_DATA + 4) << 32;
    return Data;
}

void XConv2d_hw_Set_output_r(XConv2d_hw *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_OUTPUT_R_DATA, (u32)(Data));
    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_OUTPUT_R_DATA + 4, (u32)(Data >> 32));
}

u64 XConv2d_hw_Get_output_r(XConv2d_hw *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XConv2d_hw_ReadReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_OUTPUT_R_DATA + 4) << 32;
    return Data;
}
...
void XConv2d_hw_Set_biases(XConv2d_hw *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_BIASES_DATA, (u32)(Data));
    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_BIASES_DATA + 4, (u32)(Data >> 32));
}

u64 XConv2d_hw_Get_biases(XConv2d_hw *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv2d_hw_ReadReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_BIASES_DATA);
    Data += (u64)XConv2d_hw_ReadReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_BIASES_DATA + 4) << 32;
    return Data;
}
...
void XConv2d_hw_Set_apply_relu(XConv2d_hw *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_APPLY_RELU_DATA, Data);
}

u32 XConv2d_hw_Get_apply_relu(XConv2d_hw *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv2d_hw_ReadReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_APPLY_RELU_DATA);
    return Data;
}
