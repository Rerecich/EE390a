...
# 4 "HLS_Legacy/conv2d.cpp" 2
# 1 "HLS_Legacy/conv2d.h" 1



# 1 "/scrap/users/Xilinx2022.2/Vitis_HLS/2022.2/common/technology/autopilot/ap_int.h" 1
# 5 "HLS_Legacy/conv2d.h" 2
...
{
#line 15 "/home/rerecich/EE-390a/CNN/Midterm/Vitis_Legacy/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=Conv2D_HW
# 20 "HLS_Legacy/conv2d.cpp"
...
#pragma HLS INTERFACE m_axi depth=200000 port=coeffs offset=slave
 ...
 VITIS_LOOP_32_1: for (ap_uint<32> iFilter = 0; iFilter < numFilters; ++ iFilter) {
     VITIS_LOOP_33_2: for (ap_uint<32> y = 0; y < (inputHeight-2); ++y) {
       VITIS_LOOP_34_3: for (ap_uint<32> x = 0; x < (inputWidth-2); ++ x) {
         TFXP acc;
         acc = 0;
         VITIS_LOOP_37_4: for (ap_uint<32> iChannel = 0; iChannel < numChannels; ++ iChannel) {
           VITIS_LOOP_38_5: for (ap_uint<32> cy = 0; cy < convHeight; ++ cy) {
